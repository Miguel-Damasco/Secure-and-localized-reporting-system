...
public class SecurityConfig {
    ...
    public SecurityConfig(CustomUserDetailsService pCustomUserDetailsService, JWTFilter pJWTFilter) {
        this.customUserDetailsService = pCustomUserDetailsService;
        this.jwtFilter = pJWTFilter;
    }
